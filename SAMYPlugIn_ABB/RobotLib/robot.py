...
class Robot:
    def __init__(self, ipAddress, port_motion=5000, port_logger=5001):
        ...
        self.set_unit_linear('meters')
        self.set_unit_angular('degrees')
...
class Logger:
    def __init__(self, IP='172.0.0.1', PORT=5001, maxlen=1024, verbose=False):
        self.IP      = IP
        self.PORT    = PORT
